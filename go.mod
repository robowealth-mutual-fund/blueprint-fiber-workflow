module github.com/robowealth-mutual-fund/blueprint-roa-fiber-golang
...
require (
	...
	github.com/robowealth-mutual-fund/blueprint-proto v0.0.1
	github.com/robowealth-mutual-fund/stdlog v1.2.3
